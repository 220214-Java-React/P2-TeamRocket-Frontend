...
function NavBar(){
	...
	return (<div id="navbar">
				...
				<div className="nav-button" id="nav-button-1" onClick={navigateComponents}>Pokedex</div>
				<div className="nav-button" id="nav-button-2" onClick={navigateComponents}>Competitors</div>
